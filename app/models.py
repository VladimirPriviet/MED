...
class Doenca(models.Model): # <<< ESTA CLASSE PRECISA SER ADICIONADA OU VERIFICADA
...
class Diagnostico(models.Model):
    ...
    doenca = models.ForeignKey(Doenca, on_delete=models.CASCADE, verbose_name="Doença Diagnosticada") # Depende da Doenca
